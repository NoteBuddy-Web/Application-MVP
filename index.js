...
export async function getServerSideProps() {
  try {
    ...
    const modifiedHTML = originalHTML
      ...
      // Replace direct onclick navigation to work with Next.js
      .replace(/onclick="window\.location\.href='\/settings'"/g, 'onclick="window.location.href=\'/settings\'"')
      .replace(/onclick="window\.location\.href='\/summary'"/g, 'onclick="window.location.href=\'/summary\'"')
      .replace(/onclick="window\.location\.href='\/calendar'"/g, 'onclick="window.location.href=\'/calendar\'"')
      .replace(/onclick="window\.location\.href='\/tasks'"/g, 'onclick="window.location.href=\'/tasks\'"')
      .replace(/onclick="window\.location\.href='\/record'"/g, 'onclick="window.location.href=\'/record\'"')
      // Fix the profile button navigation specifically
      .replace(/onclick="window\.location\.href='\/settings'"/g, 'onclick="window.location.href=\'/settings\'"')
      // Also fix any remaining HTML file references in onclick
      .replace(/onclick="window\.location\.href='notebuddy_prototype_calendar_view\.html'"/g, 'onclick="window.location.href=\'/calendar\'"')
      .replace(/onclick="window\.location\.href='notebuddy_prototype_summary_view\.html'"/g, 'onclick="window.location.href=\'/summary\'"')
      .replace(/onclick="window\.location\.href='notebuddy_prototype_task_list\.html'"/g, 'onclick="window.location.href=\'/tasks\'"');
